...
function Shop() {
  ...
  // ADD PRODUCT + TEMPORARILY CHANGE BUTTON
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            ...
            {filteredProducts.map((product, index) => (
              ...
              >
                ...
                {/* Wishlist */}
                <button className="absolute right-5 top-5 z-20 flex h-10 w-10 cursor-pointer items-center justify-center rounded-full bg-white shadow-md transition hover:scale-110">
                ...
                <div className="mt-5">
                  ...
                  <div className="mt-5 flex items-center justify-between gap-3">
                    ...
                    {/* TEMPORARY ADD / GO TO CART BUTTON */}
                    {addedProductId === product.id ? (

                      <Link
                        to="/cart"
                        className="flex items-center gap-2 rounded-full bg-[#8B6F5A] px-4 py-3 text-xs font-semibold text-white transition duration-300 hover:bg-[#6f5747]"
                      >
                        GO TO CART →
                      </Link>
